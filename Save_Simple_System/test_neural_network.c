...
//    sprintf(TURNING_RIGHT,"%sTURNING_RIGHT_%s.net", net_files_directory, name);
    ...
    sprintf(TWO_STAIR_ASCENT, "%s_%s.net", train_speeds[4], name);
    sprintf(TWO_STAIR_DESCENT, "%s_%s.net", train_speeds[5], name);
    sprintf(JUMPING, "%s_%s.net", train_speeds[6], name);

    sprintf(TURNING_ANN, "%s_%s.net", turning_name, name);

    sprintf(WALK_TURN_RIGHT, "%s_%s.net", train_turn_speeds[0], name);
    sprintf(WALK_TURN_LEFT, "%s_%s.net", train_turn_speeds[1], name);
    sprintf(RUN_TURN_RIGHT, "%s_%s.net", train_turn_speeds[2], name);
    sprintf(RUN_TURN_LEFT, "%s_%s.net", train_turn_speeds[3], name);
    sprintf(JUMP_TURN_RIGHT, "%s_%s.net", train_turn_speeds[4], name);
    sprintf(JUMP_TURN_LEFT, "%s_%s.net", train_turn_speeds[5], name);
