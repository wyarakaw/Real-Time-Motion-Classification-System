...
void create_names(char *name, char ***c, char **turn, char ***turn_speed){
    char **dot_net_name;
...
"home/directory"
*/
void test_neural_network(float **class_v, float **turning, float **speeds,
...
//    sprintf(TURNING_RIGHT,"%sTURNING_RIGHT_%s.net", net_files_directory, name);
    ...
    sprintf(TRAINING, "%s/%s_%s.net", dot_net_dir, activities_file, name);
    sprintf(WALKING, "%s/%s_%s.net", dot_net_dir, train_speeds[0], name);
    sprintf(RUNNING, "%s/%s_%s.net", dot_net_dir, train_speeds[1], name);
    sprintf(STAIR_ASCENT, "%s/%s_%s.net", dot_net_dir, train_speeds[2], name);
    sprintf(STAIR_DESCENT, "%s/%s_%s.net", dot_net_dir, train_speeds[3], name);
    sprintf(TWO_STAIR_ASCENT, "%s/%s_%s.net", dot_net_dir, train_speeds[4], name);
    sprintf(TWO_STAIR_DESCENT, "%s/%s_%s.net", dot_net_dir, train_speeds[5], name);
    sprintf(JUMPING, "%s/%s_%s.net", dot_net_dir, train_speeds[6], name);

    sprintf(TURNING_ANN, "%s/%s_%s.net", dot_net_dir, turning_name, name);

    sprintf(WALK_TURN_RIGHT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[0], name);
    sprintf(WALK_TURN_LEFT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[1], name);
    sprintf(RUN_TURN_RIGHT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[2], name);
    sprintf(RUN_TURN_LEFT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[3], name);
    sprintf(JUMP_TURN_RIGHT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[4], name);
    sprintf(JUMP_TURN_LEFT, "%s/%s_%s.net", dot_net_dir, train_turn_speeds[5], name);
